...
; Рассчёт стадий полёта по поверхности
...
; Решение и небольшой анализ квадратных уравнений
...
; Управление на стадии полёта над поверхностью (hover)
...
; Рассчёты стадии торможения в «стакане» над посадочной площадкой (brake).
...
; Решение для спуска. Финальное гашение скорости, если необходимо (descend).
...
; Вычисление поводка по контролю
